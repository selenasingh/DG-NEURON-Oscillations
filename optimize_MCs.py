...
class optimize_mcs(object):
    ...
    def evaluate_netparams(self, candidates, args):
        ...
        for cand in candidates:
            i = 0
            for section in self.cell_dict['secs'].keys():
    ...
    def find_bestcandidate(self):
        ...
        dendrite_minbounds = [0.5 * param for param in self.baseline[len(soma_minbounds):]]
        dendrite_maxbounds = [1.8 * param for param in
                              self.baseline[len(soma_minbounds):]]
